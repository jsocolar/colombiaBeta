...
Generate raster of distances and elevations across Colombia for predicting over. First need to rasterize the input layers (distance to range and elevation) to a 2x2 km grid.

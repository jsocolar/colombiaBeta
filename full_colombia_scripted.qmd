...
-   outputs/unit_covariates.RDS -- TODO: this needs updating

-   outputs/ffit3_copy.rds- TODO: this needs updating with final model run
...
-   outputs/xy_info_lookup.rds - TODO: where is this generated?

-   outputs/prediction_info_dt.rds - TODO: where is this generated?
...
-   outputs/predicted_occupancy_dts/averaged_posterior_10.rds - this is redundant so remove at some point.
...
```{r}
source("code/analysis_and_plotting/regional_windowing_analysis.R")
```

...
florida_mask <- st_read('inputs/nf_masks/florida_mask.kml')
baja_mask <- st_read('inputs/nf_masks/baja_mask.kml')
...
load("outputs/recast_birdlife_range_maps.Rdata") # generated by Species_lists.R

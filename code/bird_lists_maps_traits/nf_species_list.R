...
cont <- rgdal::readOGR("inputs/Continents/continent.shp", 
...
florida_mask <- st_read('inputs/WWF_ecoregions/nf_masks/florida_mask.kml')
baja_mask <- st_read('inputs/WWF_ecoregions/nf_masks/baja_mask.kml')
...
load("outputs/recast_range_maps.Rdata") # generated by Species_lists.R
...
save(nf_species, file = 'outputs/nf_species.Rdata')

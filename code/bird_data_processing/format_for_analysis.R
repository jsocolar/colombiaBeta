...
birds$sp_cl[which(birds$distance_from_range > 160000 & birds$Q==1)]
...
birds$distance_from_range_scaled2 <- boot::inv.logit(birds$distance_from_range/30000)
